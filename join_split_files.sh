...
cat system/system/reserve/CanvasResources/CanvasResources.apk.* 2>/dev/null >> system/system/reserve/CanvasResources/CanvasResources.apk
rm -f system/system/reserve/CanvasResources/CanvasResources.apk.* 2>/dev/null
